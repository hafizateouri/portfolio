...
#Let's look at which countries had the best evoluton
SELECT Country, MIN(`Life expectancy`), MAX(`Life expectancy`),
...
AND GDP <> 0
ORDER BY GDP ASC
#We notice that the higher the GDP, the higher the life expectancy. To be sure of the correlation --> visualisation on Tableau
...
#ex: en 2017 on aura que les données de 2015 à 2017 car dans SELECT on a aussi Year
FROM worldlifeexpectancy
